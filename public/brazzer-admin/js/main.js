...
$(function () {
    $('a:not(a[target="_blank"],.editable, .form-group a, a[class$="-toggle"], a[data-action="collapse"], a[data-toggle="collapse"], a[data-action="expand"], a[data-toggle="expand"],  a[data-action="tab"], a[data-toggle="tab"], a[noloading])').on('click', function () {
        $('#loading_flight').show();
    });
});
